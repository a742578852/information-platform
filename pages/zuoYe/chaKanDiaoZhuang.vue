<template>
	<view>
		...
		<view class="cu-form-group">
			...
			<input placeholder="" name="input" v-model="dzdd" ></input>
		</view>
		<view class="cu-form-group">
			<view class="title">吊车车牌号:</view>
			<input placeholder="" name="input" v-model="dccph" ></input>
		</view>
		<view class="cu-form-group">
			<view class="title">负责人:</view>
			<input placeholder="" name="input" v-model="zyfzr" ></input>
		</view>
		<view class="cu-form-group">
			<view class="title">实施安全教育人:</view>
			<input placeholder="" name="input" v-model="aqjhr" ></input>
		</view>
		<view class="cu-form-group">
		...
		<view class="cu-form-group">
			...
			<input placeholder="" name="input" v-model="qdzwzl" ></input>
		</view>
		<view class="cu-form-group">
			<view class="title">起吊最大质量:</view>
			<input placeholder="" name="input" v-model="qdzdzl" ></input>
		</view>
		<view class="cu-form-group">
